...
df = data.frame(
    Color=c("Blue", "Yellow"),
    Zero=c(sum(blues==0),sum(yellows==0)),
    One=c(sum(blues==1),sum(yellows==1)),
    Two=c(sum(blues==2),sum(yellows==2)),
    Three=c(sum(blues==3),sum(yellows==3)),
    Total=c(sum(blues),sum(yellows))
)
print(df)
